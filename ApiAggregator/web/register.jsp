...
<body>
    <a href="login.jsp">
        <div class="returns">
                <img src="static/img/leftarrow.png" style="height: 25px; width: 25px;"> Hey...I am already a user. Back to Login Man!
        </div>
    </a>
    <div class="container">
        <header>
            <h1>
                <a href="#">
                    <!--<img src="static/img/AnnyCorp.jpg" alt="Authentic Collection">-->
                </a>
            </h1>
	</header>
            
	<h1 class="text-center">Register</h1>
	<form class="registration-form" action="registerprocess.jsp">
            <label>
            ...
            <div class="text-center">
                <button class="submit" name="register">Sign Up!!</button>
            </div>
        </form>
    </div>
